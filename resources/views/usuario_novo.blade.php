...
<form method="POST" action="{{ route('usuario_inserir') }}">
	...
	<div class="form-floating mb-3">
	  <input type="text" class="form-control" id="f_endereco" placeholder="endereço" name="endereco">
	  <label for="f_endereco">Endereço</label>
	</div>
	<div class="form-floating mb-3">
	  <input type="text" class="form-control" id="f_cidade" placeholder="Cidade" name="cidade">
	  <label for="f_cidade">Cidade</label>
	</div>
	<div class="form-floating mb-3">
                                    <select class="form-control" id="f_estado" name="estado">
                                    <option>AC</option>
                                    <option>AL</option>
                                    <option>AP</option>
                                    <option>AM</option>
